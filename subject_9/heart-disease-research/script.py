...
try:
    ...
    print("Error: The file 'heart_disease.csv' was not found. Please make sure the file is in the correct directory.")
    exit()
...
tstat_hd, pval_hd_two_sided = ttest_1samp(chol_hd, 240, alternative='greater')
pval_hd_one_sided = pval_hd_two_sided
...
tstat_no_hd, pval_no_hd_two_sided = ttest_1samp(chol_no_hd, 240, alternative='greater')
pval_no_hd_one_sided = pval_no_hd_two_sided
